...
class DirectionDialogValve : DialogFragment(), OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dialogTitle = getString(R.string.popup_title_select_direction_valve)
    }
    ...
    override fun onCreateView(
        ...
        dialogTitleSub = getString(R.string.popup_title_select_direction_sub_valve)
    ...
    private fun setLayoutVisibility(view: View) {
        val defType = "id"
        resIds[2] = "plan_${parseSpiType(typeString)}_${parsePipeShape(shapeString)}_${positionInt}"
        selects[2] = view.findViewById(resources.getIdentifier("v_select_2", defType, defPackage))
        setImageView(view.findViewById(R.id.image_2), resIds[2]!!)
        arrayOf<ImageView>(
            view.findViewById(R.id.image_4),
            view.findViewById(R.id.image_6),
            view.findViewById(R.id.image_8)
        ).forEach {
            (it.parent as FrameLayout).visibility = GONE
        }
    }
    ...
    override fun onClick(v: View) {
        when (v.id) {
            R.id.btn_ok -> {
                ...
                listener.onSelect(TAG_DIRECTION_VALVE, selectIndex, resIds[selectIndex])
                if (positionInt == 5) {
            ...
            R.id.btn_cancel -> {
                listener.onSelect(TAG_DIRECTION_VALVE, -2, null)
                dismissAllowingStateLoss()
            }
