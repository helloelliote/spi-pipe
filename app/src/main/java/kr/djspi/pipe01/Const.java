...
public final class Const {
    ...
    public static final String API_SPI = "spi-get";
    public static final String API_PIPE = "pipe-get";
    ...
    public static final String[] PIPE_DIRECTIONS = {null, "nw", "n", "ne", "w", null, "e", "sw", "s", "se"};
