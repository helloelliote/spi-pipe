...
open class BaseActivity : AppCompatActivity(), OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Thread(Runnable {
            superviseDb = Room.databaseBuilder(this@BaseActivity, SuperviseDatabase::class.java, "db_supervise").build()
        }).start()
    ...
    override fun setContentView(layoutResID: Int) {
        ...
        Thread(Runnable {
            ActionBarDrawerToggle(this@BaseActivity, drawer, toolbar, R.string.nav_drawer_open, R.string.nav_drawer_close).apply {
            ...
            versionName.text = getString(R.string.nav_version_name, BuildConfig.VERSION_NAME, BuildConfig.BUILD_TYPE)
    ...
    override fun setSupportActionBar(toolbar: Toolbar?) {
        ...
        nmap_find.apply {
            ...
            setOnClickListener {
                when {
                    currentLocation != null -> startActivity(Intent(context, NaverMapActivity::class.java).setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP))
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.nav_homepage -> startActivity(Intent(Intent.ACTION_VIEW, Uri.parse(getString(R.string.nav_dj_homepage))))
